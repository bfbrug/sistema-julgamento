...
describe('useEvents', () => {
  ...
  it('useCreateEvent cria evento', async () => {
    ...
    await result.current.mutateAsync({ name: 'Novo', eventDate: '2026-01-01', location: 'L', organizer: 'O', calculationRule: 'R1', scoreMin: 0, scoreMax: 10, topN: 3, genderMode: 'MIXED' })
